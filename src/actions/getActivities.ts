...
export const updateBank = async (info: {
  bankName: string;
  fullName: string;
  rib: string;
}) => {
  try {
    const res = await fetch(`${API_URL}/user/edit-profil/bank`, {
      method: "PATCH",
      credentials: "include", // Ensures cookies are sent automatically
      headers: {
        "Content-Type": "application/json",
...
export const banUser = async (id: string) => {
  try {
    const res = await fetch(`${API_URL}/user/ban/${id}`, {
      method: "PATCH",
      credentials: "include", // Ensures cookies are sent automatically
      headers: {
        "Content-Type": "application/json",
...
export const banActivity = async (id: string) => {
  try {
    const res = await fetch(`${API_URL}/activity/ban/${id}`, {
      method: "PATCH",
      credentials: "include", // Ensures cookies are sent automatically
      headers: {
        "Content-Type": "application/json",
