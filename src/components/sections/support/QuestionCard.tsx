...
export default function QuestionCard({
  ...
  return (
    <div
      className={cn(
        "w-[329px] cursor-pointer space-y-2 rounded-[8px] border border-neutralLightActive px-[18px] py-5 tablet:w-[676px] tablet:space-y-[13px] tablet:p-4 laptop:w-[1096px]",
        activities && "w-full tablet:w-full laptop:w-full",
      )}
