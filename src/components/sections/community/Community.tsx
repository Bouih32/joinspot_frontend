...
export default function Community() {
  ...
  return (
    <section className="overflow-hidden bg-secondLight py-[48px] tablet:py-[70px]">
      <Container classname="flex flex-col gap-[30px] tablet:flex-row tablet:gap-[63px] laptop:gap-[106px]">
        <section className="space-y-3 text-center tablet:w-[356px] tablet:space-y-[32px] tablet:text-start">
          ...
          <SubTitle classname="tablet:w-[356px]">
            You're welcome! Here’s a clean and engaging <br /> Review Section
            for
